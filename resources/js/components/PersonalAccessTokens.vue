...
<template>
    <div>
        ...
        <!-- Create Token Modal -->
        <div class="bsmodal modal fade" id="modal-create-token" tabindex="-1" role="dialog">
                    ...
                    <div class="modal-body">
                        ...
                        <form role="form" @submit.prevent="store">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="create-token-name" type="text" class="w-full border border-light-grey p-2" name="name" v-model="form.name">
                                </div>
                            </div>
        ...
        <!-- Access Token Modal -->
        <div class="bsmodal modal fade" id="modal-access-token" tabindex="-1" role="dialog">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">
                    ...
                    <div class="modal-body">
                        ...
                        <textarea class="w-full border border-light-grey text-sm" rows="22">{{ accessToken }}</textarea>
                    </div>
